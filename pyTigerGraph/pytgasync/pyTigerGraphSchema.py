...
class AsyncPyTigerGraphSchema(AsyncPyTigerGraphBase):
    ...
    async def createGraph(self, graphName: str,
        ...
        if await self._version_greater_than_4_0():
            ...
            res = _wrap_gsql_result(await self.gsql(gsql_cmd))
    ...
    async def listGraphs(self) -> list:
    ...
    async def runSchemaChange(self, gsqlStatements: Union[str, list, dict],
    ...
    async def createSchemaChangeJob(self, jobName: str, statements: Union[str, list, dict],
        ...
        if isinstance(statements, dict):
            ...
            if gname:
                params["graph"] = gname
            res = await self._req("POST", url, params=params,
    ...
    async def getSchemaChangeJobs(self, jobName: str = None, graphName: str = None,
        ...
        res = await self._req("GET", url, params=params, authMode="pwd",
                             resKey=None)
    ...
    async def runSchemaChangeJob(self, jobName: str, graphName: str = None,
        ...
        res = await self._put(url, authMode="pwd", resKey=None, params=params)
    ...
    async def dropSchemaChangeJobs(self, jobNames: Union[str, list],
                                   graphName: str = None) -> dict:
        ...
        res = await self._req("DELETE", self.gsUrl + "/gsql/v1/schema/jobs",
                             params=params, authMode="pwd", resKey=None)
