...
from pyTigerGraph.common.auth import PyTigerGraphAuthBase
from pyTigerGraph.pytgasync.pyTigerGraphGSQL import AsyncPyTigerGraphGSQL

logger = logging.getLogger(__name__)


class AsyncPyTigerGraphAuth(PyTigerGraphAuthBase, AsyncPyTigerGraphGSQL):
    ...
    async def createSecret(self, alias: str = "", withAlias: bool = False) -> Union[str, Dict[str, str]]:
        ...
        secret = self._parse_create_secret(
    ...
    async def _token(self, secret: str = None, lifetime: int = None, token=None, _method=None) -> Union[tuple, str]:
        method, url, alt_url, authMode, data, alt_data = self._prep_token_request(
    ...
    async def getToken(self, secret: str = None, setToken: bool = True, lifetime: int = None) -> Union[tuple, str]:
        ...
        token = self._parse_token_response(res, setToken, mainVer)
    ...
    async def refreshToken(self, secret: str = None, setToken: bool = True, lifetime: int = None, token="") -> Union[tuple, str]:
        ...
        newToken = self._parse_token_response(res, setToken, mainVer)
