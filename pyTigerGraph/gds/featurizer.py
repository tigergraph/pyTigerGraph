...
class Featurizer:
    def __init__(
        ...
        if not algo_version:
            ...
            major_ver, minor_ver = algo_version.split(".")
        # Get repo address
        if not repo:
        ...
        self.queryResult_type_dict = {
            "tg_pagerank": "Float",
            "tg_article_rank": "Float",
            "tg_betweenness_cent": "Float",
            "tg_closeness_cent": "Float",
            "tg_closeness_cent_approx": "Float",
            "tg_degree_cent": "INT",
            "tg_eigenvector_cent": "Float",
            "tg_harmonic_cent": "INT",
            "tg_pagerank_wt": "Float",
            "tg_scc": "INT",
            "tg_kcore": "INT",
            "tg_lcc": "Float",
            "tg_bfs": "INT",
            "tg_shortest_ss_no_wt": "INT",
            "tg_fastRP": "LIST<DOUBLE>",
            "tg_label_prop": "INT",
            "tg_louvain": "INT",
        }  # type of features generated by graph algorithms
