...
from pyTigerGraph.common.auth import pyTigerGraphBaseAuth

logger = logging.getLogger(__name__)


class pyTigerGraphAuth(pyTigerGraphBaseAuth, pyTigerGraphGSQL):
