...
class pyTigerGraphAuth(pyTigerGraphGSQL):
    ...
    def getSecrets(self, userName: str = "", alias: str = "", createNew: bool = False) -> Dict[str, str]:
        ...
        try:
            if alias:
                ...
                try:
                    res = self._get(self.gsUrl+"/gsql/v1/secrets/"+alias,
                                   authMode="pwd",
                ...
                if res and isinstance(res, dict) and res.get("alias"):
                    ...
                    created_secret = self.createSecret(alias=alias, userName=userName, withAlias=True)
                ...
                res = self._get(self.gsUrl+"/gsql/v1/secrets",
                ...
                if not ret and createNew:
                    created_secret = self.createSecret(userName=userName, withAlias=True)
                    if isinstance(created_secret, dict):
                        ret.update(created_secret)
                    else:
                        # This shouldn't happen with withAlias=True, but handle it
    ...
    def createSecret(self, alias: str = "", withAlias: bool = False, value: str = "", userName: str = "" ) -> Union[str, Dict[str, str]]:
        ...
        try:
            ...
            res = self._post(self.gsUrl+"/gsql/v1/secrets",
                           params=params, authMode="pwd",
                           headers={'Content-Type': 'application/json'})
    ...
    def dropSecret(self, alias: Union[str, list], ignoreErrors: bool = True, userName: str = "") -> Union[str, dict]:
        """Drops a secret.
    ...
    def _token(self, secret: str = None, lifetime: int = None, token: str = None, _method: str = None, is_global: bool = True) -> Union[tuple, str]:
    ...
    def getToken(self,
                 ...
                 setToken: bool = True,
                 lifetime: int = None,
                 is_global: bool = True) -> Union[Tuple[str, str], str]:
        ...
        res, mainVer = self._token(secret, lifetime, is_global=is_global)
