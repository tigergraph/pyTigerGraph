...
class pyTigerGraphBase(PyTigerGraphCore, object):
    ...
    def _req(self, method: str, url: str, authMode: str = "token", headers: dict = None,
        ...
        if res is not None:
            ...
            if res.status_code == 401 and getattr(self, "_token_source", None) == "generated" \
                    and not getattr(self, "_refreshing_token", False):
                try:
    ...
    def _put(self, url: str, authMode: str = "token", data=None, resKey=None,
        ...
        res = self._req("PUT", url, authMode, data=data,
                        resKey=resKey, jsonData=jsonData, params=params)
