...
class test_pyTigerGraphEdgeAsync(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        self.conn = await make_connection()

    async def test_01_getEdgeTypes(self):
    ...
    async def test_02_getEdgeType(self):
        ...
        res = await self.conn.getEdgeType("edge2_directed")
        self.assertIsNotNone(res)
        self.assertIsInstance(res, dict)
        self.assertIn("IsDirected", res)
        ...
        res = await self.conn.getEdgeType("edge3_directed_with_reverse")
        self.assertIsNotNone(res)
        self.assertIsInstance(res, dict)
        self.assertIn("IsDirected", res)
        self.assertTrue(res["IsDirected"])
        ...
        res = await self.conn.getEdgeType("edge5_all_to_all")
        self.assertIsNotNone(res)
        self.assertIsInstance(res, dict)
        self.assertIn("ToVertexTypeName", res)
        self.assertEqual("*", res["ToVertexTypeName"])
    ...
    async def test_03_getEdgeSourceVertexType(self):
        res = await self.conn.getEdgeSourceVertexType("edge1_undirected")
        self.assertIsInstance(res, str)
        self.assertEqual("vertex4", res)

    async def test_04_getEdgeTargetVertexType(self):
        res = await self.conn.getEdgeTargetVertexType("edge2_directed")
        self.assertIsInstance(res, str)
        self.assertEqual("vertex5", res)

    async def test_05_isDirected(self):
        res = await self.conn.isDirected("edge1_undirected")
        self.assertIsInstance(res, bool)
        self.assertFalse(res)
        res = await self.conn.isDirected("edge2_directed")
        self.assertIsInstance(res, bool)
        self.assertTrue(res)
    ...
    async def test_07_getEdgeCountFrom(self):
        res = await self.conn.getEdgeCountFrom(edgeType="*")
        self.assertIsInstance(res, dict)
        ...
        res = await self.conn.getEdgeCountFrom(edgeType="edge4_many_to_many")
    ...
    async def test_08_getEdgeCount(self):
        res = await self.conn.getEdgeCount("*")
        self.assertIsInstance(res, dict)
        self.assertIn("edge1_undirected", res)
        self.assertEqual(8, res["edge1_undirected"])
        self.assertIn("edge6_loop", res)
        ...
        res = await self.conn.getEdgeCount("edge4_many_to_many")
        self.assertIsInstance(res, int)
        self.assertEqual(8, res)

        res = await self.conn.getEdgeCount("edge4_many_to_many", "vertex4")
        self.assertIsInstance(res, int)
        self.assertEqual(8, res)

        res = await self.conn.getEdgeCount("edge4_many_to_many", "vertex4", "vertex5")
        self.assertIsInstance(res, int)
        self.assertEqual(3, res)
    ...
    async def test_09_upsertEdge(self):
        ...
        res = await self.conn.upsertEdge("vertex6", 6, "edge4_many_to_many", "vertex7", 6)
        self.assertIsInstance(res, int)
        self.assertEqual(1, res)
    ...
    async def test_10_upsertEdges(self):
        ...
        res = await self.conn.upsertEdges("vertex6", "edge4_many_to_many", "vertex7", es)
        self.assertIsInstance(res, int)
    ...
    async def test_12_getEdges(self):
        ...
        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected")
        self.assertIsInstance(res, list)
        self.assertEqual(3, len(res))

        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected", "vertex5")
        self.assertIsInstance(res, list)
        self.assertEqual(3, len(res))

        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected", "vertex5", 2)
        self.assertIsInstance(res, list)
        self.assertEqual(1, len(res))

        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected", select="a01", where="a01>1")
        self.assertIsInstance(res, list)
        self.assertEqual(2, len(res))

        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected", sort="-a01", limit=2)
        self.assertIsInstance(res, list)
        self.assertEqual(2, len(res))

        res = await self.conn.getEdges("vertex4", 1, "edge1_undirected", "vertex5", fmt="json")
        self.assertIsInstance(res, str)
        res = json.loads(res)
        self.assertIsInstance(res, list)
        self.assertEqual(3, len(res))
    ...
    async def test_13_getEdgesDataFrame(self):
        res = await self.conn.getEdgesDataFrame("vertex4", 1, "edge1_undirected", "vertex5")
        self.assertIsInstance(res, pandas.DataFrame)
        self.assertEqual(3, len(res.index))

    async def test_14_getEdgesByType(self):
        res = await self.conn.getEdgesByType("edge1_undirected")
        self.assertIsInstance(res, list)
        self.assertEqual(8, len(res))

    async def test_15_getEdgesDataFrameByType(self):
        pass

    async def test_16_getEdgeStats(self):
        res = await self.conn.getEdgeStats("edge1_undirected")
        self.assertIsInstance(res, dict)
        self.assertEqual(1, len(res))
        self.assertIn("edge1_undirected", res)
        ...
        res = await self.conn.getEdgeStats("*", skipNA=True)
        self.assertIsInstance(res, dict)
        self.assertIn("edge3_directed_with_reverse", res)
        self.assertNotIn("edge4_many_to_many", res)

    async def test_17_delEdges(self):
        res = await self.conn.delEdges("vertex6", 1)
        self.assertIsInstance(res, dict)
        self.assertEqual(7, len(res))
        self.assertIn("edge4_many_to_many", res)
        self.assertEqual(1, res["edge4_many_to_many"])

        res = await self.conn.delEdges("vertex6", 6, "edge4_many_to_many")
        self.assertIsInstance(res, dict)
        self.assertEqual(1, len(res))
        self.assertIn("edge4_many_to_many", res)
        self.assertEqual(1, res["edge4_many_to_many"])
        ...
        res = await self.conn.delEdges("vertex6", 2, "edge4_many_to_many", "vertex7", 1)
        self.assertIsInstance(res, dict)
        self.assertEqual(1, len(res))
        self.assertIn("edge4_many_to_many", res)
        self.assertEqual(1, res["edge4_many_to_many"])

        res = await self.conn.delEdges("vertex6", 2, "edge4_many_to_many", "vertex7")
        self.assertIsInstance(res, dict)
        self.assertEqual(1, len(res))
        self.assertIn("edge4_many_to_many", res)
