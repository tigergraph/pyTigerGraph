...
def send_github_api_request(url_tail, method='GET', data=None, silent=False,
    ...
    """
    if github_token == "":
        github_token = "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"
    headers = {
    ...
    url = 'https://api.github.com/repos/shenwen33/' + url_tail
    while retry >= 0:
        try:
...
if __name__ == "__main__":
    ...
    push_comment_to_pull_request(param[1],param[2],param[3],param[4])
    #push_comment_to_pull_request('ci-test', "8", "PASSSSS", "COMMENT")