...
def read_config_file():
    ...
    jenkins_config_file = '../../config/config.json' if not jenkins_id or "prod_sv4" in jenkins_id else f"../../config/config_{jenkins_id}.json"
...
if __name__ == "__main__":
    res = run_bash("hostname")
    print(res)
    #need to figure out parameters
    res = parse_parameter(["rep1#1;rep2#2"],1)
    print(res)
    dictFrom = {1 : "a",2: "b"}
    dictTo = {1: "c",3: "d"}
    dict_overwrite(dictFrom,dictTo)
    print(dictTo)
