...
def mergeable_check(repo_dict):
    ...
    for repo, num in repo_dict.items():
        ...
        if not mergeable:
            raise util.MergeFail(
                repo + '#' + str(num) + ' is not mergeable! Please merge your feature branch with master.mergeable_state from Github: ' + mergeable_state
            )
    # end for                                                                                                                                        
...
def main(parameters):
    ...
    mergeable_check(param_dict)
    # then merge one by one                                                                                                                          
    merge_pull_request(param_dict, parameters[2], parameters[3])
# end function main                                                                                                                                  
